document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://localhost:5087/student/api/student/transaction', {
      method: 'GET',
      headers: {
        ...
        if (response.status===200) {
          return response.json().then(data => {
            console.log(data)
            document.getElementById('t_amount').innerHTML = data.totalPay;
            document.getElementById('t_bill').innerHTML = data.totalBilling;
            document.getElementById('t_tobal').innerHTML = data.totalToBal;
            ...
            data.transactions.$values.forEach((transaction, index) => {
                ...
                <tr>
                    ...
                    <td><button data-id="${transaction.id}" class="btn btn-success btn-sm print-receipt-btn"style="font-size:0.75em" >
