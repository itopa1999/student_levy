document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('http://localhost:5087/student/api/get/student/profile', {
      method: 'GET',
      headers: {
        ...
        document.getElementById('stuDepartmentType').innerHTML = data.departmentType;
        document.getElementById('stuDepartmentYear').innerHTML = data.departmentYear;
    }).catch(error => {
    ...
    document.querySelector('.StudentChangePassword-form').addEventListener('submit', function(event) {
